...
<head>
<meta charset="UTF-8">
<title>CHANNEL / kakaocheck</title>
		...
		$(function() {
			...
			//m_redirect_url : 'http://www.naver.com'
				...
				if (rsp.success) {
					...
					//성공시 이동할 페이지
					alert("결제 성공!")
					//location.href="pay_credit_ordersheet.jsp";
					location.href="pay_res.jsp?name="+name+"&email="+email+"&phone="+phone+"&type="+type+"&totalPrice="+totalPrice;

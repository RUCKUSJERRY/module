	...
	<div class="container">
		<form class="form-signin" action="../MemberControllerlyj" method="post">
			...
			<label for="inputID" class="sr-only">ID</label> 
				<input type="text" id="inputID" class="form-control" placeholder="ID" name="member_id" required autofocus>
			<label for="inputPassword" class="sr-only">Password</label>
				 <input type="password" id="inputPassword" class="form-control"	placeholder="Password" name="member_pw" required>
			<br>
